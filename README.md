...
| Node **1.2.1** | https://github.com/rgsneddon/gnfp-node/releases/tag/v1.2.1 |
...
`--notls` is local plaintext only. Public nodes stay TLS.
...
| Relay **GNFPHash** miners into the live node | Accept leftover `gnfp-mine` / GPU / ASIC |
